    ...
    <div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">INSERTAR</div>
            </div>  
            <div class="panel-body" >
                <form method="get" action="mod/insert.php">
                    <input type='hidden' name='csrfmiddlewaretoken' value='XFe2rTYl9WOpV8U6X5CfbIuOZOELJ97S' />
           
                    <form  class="form-horizontal" name="formulari1" method="get" action="mod/insert.php">
                        <input type='hidden' name='csrfmiddlewaretoken' value='XFe2rTYl9WOpV8U6X5CfbIuOZOELJ97S' />
                        ...
                        <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="nom" value="" placeholder="Inserte nombre" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
						...
						<div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="localitat" value="" placeholder="Inserte Localidad" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
						
						<div id="div_id_username" class="form-group required">
                            <label for="id_username" class="control-label col-md-4  requiredField">WEB<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="100" name="web" value="" placeholder="Inserte Web" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
						
						<div id="div_id_username" class="form-group required">
                            <label for="id_username" class="control-label col-md-4  requiredField">Escudo<span class="asteriskField">*</span> </label>
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="100" name="escut" value="" placeholder="Inserte Escudo" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
